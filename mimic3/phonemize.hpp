...
namespace mimic3
{
    ...
    void loadPhonemeIdMap(std::istream &inputStream, PhonemeIdMap *idMap)
    {
        int64_t id;
        std::string phoneme;
    ...
    void phonemize(mimic3_Request &request)
    {
        ...
        while (inputTextPointer != NULL)
        {
            ...
            utf8::iterator phonemeIter(
                clausePhonemes.begin(), clausePhonemes.begin(), clausePhonemes.end());
            utf8::iterator phonemeEnd(
                clausePhonemes.end(), clausePhonemes.begin(), clausePhonemes.end());
